...
export const SOCKET = io('https://4235-212-31-49-235.eu.ngrok.io', { transports: ["websocket"] });
...
export const firstLogin = async (username: string) => {
   SOCKET.emit('userName', username);
   if (username) {
      SOCKET.on('userNameAv', (res: boolean) => {
         console.log('res', res)
         return res;
      });
   }
